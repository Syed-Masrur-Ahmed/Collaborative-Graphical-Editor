...
public class Editor extends JFrame {	
	...
	private void handlePress(Point p) {
		// TODO: YOUR CODE HERE
		Integer id = sketch.contains((int)p.getX(), (int)p.getY());
		if (mode == Mode.DRAW) {
			drawFrom = p;
			if (shapeType.equals("ellipse")) curr = new Ellipse((int)p.getX(), (int)p.getY(), color);
			else if (shapeType.equals("freehand")) curr = new Polyline(color);
			else if (shapeType.equals("rectangle")) curr = new Rectangle((int)p.getX(), (int)p.getY(), color);
			else if (shapeType.equals("segment")) curr = new Segment((int)p.getX(), (int)p.getY(), color);
		}
	...
	private void handleDrag(Point p) {
		...
		if (mode == Mode.DRAW) {
			...
			String message = "move " + movingId + " " + (int)(p.getX()-moveFrom.getX()) + " " + (int)(p.getY()-moveFrom.getY());
			comm.send(message);
			moveFrom = p;
		}
		repaint();
